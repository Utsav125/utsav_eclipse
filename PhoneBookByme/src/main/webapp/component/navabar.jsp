...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	<a class="navbar-brand" href="Index.jsp"> <i
		class="fa-solid fa-phone"></i>PhoneBook
	</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link"
				href="addContact.jsp"><i class="fa-solid fa-user-plus"></i>Add
					Phone Number</a></li>
			<a class="nav-link active" href="ViewContact.jsp"> <i
				class="fa-solid fa-eye"></i>View Contact
			</a>
			</li>
		</ul>
		<%
		...
		<form class="form-inline my-2 my-lg-0">
			<a href="Login.jsp" class="btn btn-success"> <i
				...
				class="fa-solid fa-address-card"></i>Register
			</a>
